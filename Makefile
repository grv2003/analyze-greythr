...
datasets:
	source venv/bin/activate && convert bundle/analyze/datasets/tap-greythr/ rawdata/ bundle/analyze/datasets/tap-greythr/output || convert bundle/analyze/datasets/tap-greythr/ rawdata/ bundle/analyze/datasets/tap-greythr/output
